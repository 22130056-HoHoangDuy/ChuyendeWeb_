              ...
              child: Stack(
                children: [
                  Container(
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage('assets/login_img.png'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  const Positioned(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("SweetDream", style: TextStyle(color: Colors.white, fontSize: 48, fontWeight: FontWeight.bold)),
                        SizedBox(height: 10),
                        Text("Kiến tạo không gian mơ ước,\ngiao gửi yêu thương đến tận phòng của bé.", style: TextStyle(color: Colors.white70, fontSize: 18, height: 1.5)),
                      ],
                    ),
                  ),
                ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Wrap(
                            children: [
                              const Text("Bạn mới biết đến SweetDream ? "),
                              GestureDetector(
                                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const RegisterPage())),
                                child: Text("Tạo tài khoản", style: TextStyle(color: primaryPurple, fontWeight: FontWeight.bold)),
                              ),
