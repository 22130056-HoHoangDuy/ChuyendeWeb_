                ...
                children: [
                  Container(
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage('assets/register_img.png'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  const Positioned(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("SweetDream", style: TextStyle(color: Colors.white, fontSize: 42, fontWeight: FontWeight.bold)),
                        SizedBox(height: 10),
                        Text("Nâng niu không gian sáng tạo, trọn vẹn từng giấc mơ con.",
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text("Tham gia SweetDream để mua sắm nông sản sạch", style: TextStyle(color: Colors.grey)),
